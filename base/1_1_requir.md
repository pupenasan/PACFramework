...
Вимоги до функціональності PFw сформовані у результаті аналізу вимог до функціонування АСКТП різного призначення, проблем їх розроблення, введення в дію та експлуатації. Серед них варто виділити наступні:
...
8.  складність, значні затрати часу на розроблення ПЗ
...
--> [1.2 Базові технології в основі PFw](1_2_tech.md)
