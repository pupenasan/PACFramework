...
Тут розглядається приклад розгортання проекту в Uinity PRO/Control Expert. 
...
Перевірка VLVD на рівні ПЛК:

Для перевірки добавте `VLVDS_HMI.VNabor_T1`, `VLVDS.VNabor_T1` та `ACTBUF` в Animation Table
