...
- [ ] Створіть новий проект на базі стартового проекту SA, наприклад з назвою `ExamplePFW_depl`
- [ ] Створіть одного користувача з правами (на базі ролі) адміністратора
- [ ] Створіть два I/O Device, з яким буде відбуватися зв'язок, приклад розроблений з урахуванням Modbus TCP/IP:
  - PLC1
  - PLC2
...
- [ ] Відкрийте прешй проект Unity PRO (Control Expert) і зробіть експорт проекту в папку що вказана в ini-файлі як `plcsourcepath` та іменем `plc1.xef`
- [ ] повторіть те саме з іншим проектом з іменем  `plc2.xef`
