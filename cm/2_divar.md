...
- якщо логіний номер каналу не заданий - записати значення по замовчування  `DIVARCFG.CHID := DIVARCFG.CHIDDF;`
...
| ----- | ------------------------------------------------------------ | ------------------------------------------------------------ | -------- |
| 1     | Змінити STA.X15:=1 для однієї зі змінних DIVAR_HMI           | у VARBUF повинно завантажитися весь зміст DIVAR_CFG<br />для DIVAR_HMI повинен STA.X15 = 0 <br />для DIVAR_HMI, DIVAR_CFG та DIVAR_BUF повинне STA.12(INBUF)=1 |          |
| 2     | Змінити значення фізичного каналу DICH до якого прив'язана технологічна змінна (наприклад форсувати) | відповідне значення зміниться у DIVAR_HMI, DIVAR_CFG та DIVAR_BUF |          |
...
| 1     | Змінити STA.X15:=1 для однієї зі змінних DIVAR_HMI           | у VARBUF повинно завантажитися весь зміст DIVAR_CFG<br />для DIVAR_HMI повинен STA.X15 = 0 <br />для DIVAR_HMI, DIVAR_CFG та DIVAR_BUF повинне STA.12(INBUF)=1 |          |
| 2     | Змінити значення фізичного каналу DICH до якого прив'язана технологічна змінна (наприклад форсувати) | відповідне значення зміниться у DIVAR_HMI, DIVAR_CFG та DIVAR_BUF |          |
| 3     | Змінити значення фізичного каналу DICH до якого прив'язана технологічна змінна на протилежне (наприклад форсувати) | відповідне значення зміниться у DIVAR_HMI, DIVAR_CFG та DIVAR_BUF |          |
|       |                                                              |                                                              |          |
...
| ----- | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------ |
| 1     | Змінити STA.X15:=1 для однієї зі змінних DIVAR_HMI           | у VARBUF повинно завантажитися весь зміст DIVAR_CFG<br />для DIVAR_HMI повинен STA.X15 = 0 <br />для DIVAR_HMI, DIVAR_CFG та DIVAR_BUF повинне STA.12(INBUF)=1 |                                            |
| 2     | Відправити команду форсування CHBUF.CMD=16#0301              | біт STA.FRC повинен дорівнювати 1                            |                                            |
| 3     | Змінити значення фізичного каналу DICH до якого прив'язана технологічна змінна (наприклад форсувати) | відповідне значення у DIVAR_HMI, DIVAR_CFG та DIVAR_BUF не повинно змінюватись |                                            |
...
| ----- | ------------------------------------------------------------ | ------------------------------------------------------------ | -------- |
| 1     | Змінити STA.X15:=1 для однієї зі змінних DIVAR_HMI           | у VARBUF повинно завантажитися весь зміст DIVAR_CFG<br />для DIVAR_HMI повинен STA.X15 = 0 <br />для DIVAR_HMI, DIVAR_CFG та DIVAR_BUF повинне STA.12(INBUF)=1 |          |
| 2     | Відправити команду форсування CHBUF.CMD=16#0311              | біт STA.SML повинен дорівнювати 1                            |          |
| 3     | Змінити значення фізичного каналу DICH до якого прив'язана технологічна змінна (наприклад форсувати) | відповідне значення у DIVAR_HMI, DIVAR_CFG та DIVAR_BUF не повинно змінюватись |          |
| 4     | Змінити значення DIVAR_CFG.STA.VALB на 1                     | відповідне значення зміниться у DIVAR_HMI та DIVAR_BUF, а значення з DICH буде ігноруватись |          |
| 5     | Відправити команду форсування CHBUF.CMD=16#0312              | біт STA.SML повинен дорівнювати 0<br />DIVAR_CFG.STA.VALB прийме значення таке ж як і DICH |          |
|       | Перевірити значення змінних PLC.STA_PERM                     | біт про наявність імітованих об'єктів PLC.STA_PERM.X14=1     |          |
|       |                                                              |                                                              |          |
|       |                                                              |                                                              |          |
|       |                                                              |                                                              |          |
