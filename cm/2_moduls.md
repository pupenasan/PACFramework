...
| STA2    | UINT                | 3    |      | додаткові стани модуля для HMI: xxxx_xxxx_xxxx_1111 - останні 4 біти відповідають за FRC хоча б одного каналу конкретного субмодуля; xxxx_xxxx_1111_xxxx - наявність вільних каналів (не використовуваних) на конкретному підмодулі; |
